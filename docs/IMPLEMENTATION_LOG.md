...
|---|---:|---:|---:|---:|
| Sample 01 | 16.1 s | 0.0 s | 1.056x | 172.770 s |
| Sample 02 | 2.3 s | 0.4 s | 1.081x | 228.782 s |
| Sample 03 | 4.7 s | 0.8 s | 1.017x | 70.598 s |
...
- [ ] Keep the private `nvidian/tegra-audio` image reference out of external
  documentation unless NVIDIA explicitly grants evaluation partner access
