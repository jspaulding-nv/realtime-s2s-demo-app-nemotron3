...
delay later in a 30- or 40-minute sermon.
...
- **Semantic criteria:** marked-utterance and punchline delays acceptable to
  Pellera's audience, including transient delays after pauses or delivery
  stalls.
- **Quality criteria:** native listeners consider 1.05x/1.10x speech
  intelligible and natural enough for a sermon-length session.
