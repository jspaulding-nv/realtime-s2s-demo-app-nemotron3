...
standalone smoke tool and unit-test fakes. This keeps the earlier three-sermon
...
deployed profiles. It does not yet establish sermon-length stability.
...
could still make laughter feel late as a sermon continues even when the
...
4. Extend the batch runner to select the staged route and rerun Spirit,
   Blessed, and Beholding end to end.
