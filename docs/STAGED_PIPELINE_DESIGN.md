...
implemented or validated by a new live sermon run in this branch.
...
punctuation handling for these sermon files.
...
first. Reordered sermon sentences would be a correctness failure even if the
