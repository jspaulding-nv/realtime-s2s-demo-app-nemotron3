...
**Source:** Jonathan Gough's `realtime-s2s-demo-app`
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Spirit | 1,908.4s | 16.1s | 0.0s | 1.056x | 107.5s | 172.8s | 65.4s |
| Blessed | 2,427.0s | 2.3s | 0.4s | 1.081x | 197.2s | 228.8s | 31.3s |
| Beholding | 1,888.1s | 4.7s | 0.8s | 1.017x | 31.4s | 70.6s | 39.0s |
...
## Comparison with Jonathan's three prior runs
...
|---|---|---:|---:|---:|
| Spirit | 226.1s, 162.2s, 226.0s | 204.8s | 172.8s | 15.6% reduction |
| Blessed | 207.1s, 261.0s, 220.4s | 229.5s | 228.8s | 0.3% reduction |
| Beholding | 146.0s, 145.7s, 145.2s | 145.7s | 70.6s | 51.5% reduction |

The duration-excess-only proxy also improved:

| File | Prior mean | Nemotron run | Change |
|---|---:|---:|---:|
| Spirit | 170.5s | 107.5s | 36.9% reduction |
| Blessed | 214.9s | 197.2s | 8.2% reduction |
| Beholding | 115.6s | 31.4s | 72.8% reduction |

## Interpretation

- Beholding improved substantially and Spirit improved moderately, consistent
  with the direction reported by the Riva team.
- Blessed did not show a meaningful listener-tail improvement in this run.
...
- Peak positive drift increased versus the prior-run means: Spirit 33.9s to
  65.4s, Blessed 14.4s to 31.3s, and Beholding 29.7s to 39.0s. The 800 ms EOU
...
- If Blessed remains near a 3–4 minute playback tail, evaluate 1.05x and 1.10x
